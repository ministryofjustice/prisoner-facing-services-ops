...
# Version: Initial release 02 Name: reportWMIaudit02 Date: 06/12/2018 Change: Combined Report     #   
#                                                                                                 #
#                                                                                                 #
#--------------------------------------------------------------------------------------------------
...
#dynamic variables 
    ...
    #output folder
    $path="c:\Scripts\JS\02"
    #output file name
    $fullPath=$path+"Combined.htm" 
    #days prior to check logs
    $daysSystemLog=10
...
#Define Table
    ...
    Foreach($server in $Servers){
        ...
        #buid the report body per server
...
ConvertTo-HTML -head $tab -Body $body -Title "<h1>Server Audit</h1>" | out-file $fullPath 
